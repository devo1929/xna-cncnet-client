...
public class CnCNetLobbyService
{
    ...
    private readonly BehaviorSubject<string> logoutButtonTextSubject;
    private readonly BehaviorSubject<SourcePanelEnum> sourcePanelSubject;
    ...
    )
    {
        ...
        logoutButtonTextSubject = new BehaviorSubject<string>(null);
    ...
    public async ValueTask JoinGameAsync(GenericHostedGame hostedGame, string password = null)
    {
        ...
        {
            sourcePanelSubject.OnNext(SourcePanelEnum.Primary);
            return;
        }
    ...
    public IObservable<string> GetLogoutButtonText() => logoutButtonTextSubject.AsObservable();

    public IObservable<SourcePanelEnum> GetSourcePanel() => sourcePanelSubject.AsObservable();
