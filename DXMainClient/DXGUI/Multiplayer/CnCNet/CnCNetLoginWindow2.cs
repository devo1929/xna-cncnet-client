...
{
    class CnCNetLoginWindow2 : XNAWindow
    {
        private readonly CnCNetLobbyService cncnetLobbyService;

        public CnCNetLoginWindow2(
        ...
        public override void Initialize()
        {
            ...
            cncnetLobbyService.GetPromptLogin().Subscribe(PromptLogin);
        }

        private void PromptLogin(bool prompt)
        {
            if (!prompt)
            {
                Disable();
        ...
        {
            cncnetLobbyService.LoginCancel();
        }
        ...
        private void BtnConnect_LeftClick(object sender, EventArgs e)
        {
            ...
            cncnetLobbyService.LoginConnect();
        }
